...
if __name__ == "__main__":
    os.chdir("C:/Users/jisan/OneDrive/Documents/Workspace/nlp-statisticsmodel/jisang/nlp_packaJi/analyzer/")
    
    df_train = pd.read_csv("train.csv")
    df_test = pd.read_csv("test.csv")

    X_train, Y_train = df_train['mail'].tolist(), df_train['label'].tolist()
    X_test, Y_test = df_train['mail'].tolist(), df_train['label'].tolist()

...
class NaiveBayesClassifier():
    ...
    def train(self, docs, labels, k = 0.5, model = 'nbc.model'):
        ...
        with open(model, 'wb') as f:
            tmp = {'label_prob' : label_prob, 'nbc_dic' : self.nbc_dic, 'i2label' : self.i2label, 'label2i' : self.label2i}
            pickle.dump(tmp, f)
    ...
    def predict(self, docs, model = None):
        ...
        for d in tokenized_docs:
            ...
            results.append(self.i2label[result.argsort()[::-1][0]])
...
if __name__ == "__main__":
    # import pandas as pd
    # import os
    os.chdir('C:\\Users\\student\\JEONGYEON\\jeongyeon_nlp\\analyzer')
